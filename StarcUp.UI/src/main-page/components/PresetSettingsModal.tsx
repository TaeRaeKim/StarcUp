                ...
                {[RaceType.Protoss, RaceType.Terran, RaceType.Zerg].map((raceKey) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-lg border-2 transition-all duration-300 hover:bg-opacity-80 ${isSelected ? 'border-current' : ''
                        }`}
                      style={{
                        backgroundColor: 'var(--starcraft-bg-secondary)',
              ...
              <div className="grid grid-cols-1 gap-3">
                {FEATURE_CONFIG.map((feature, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`flex items-center justify-between p-4 rounded-sm border transition-all duration-300 ${isDisabled ? 'opacity-30' : 'hover:bg-opacity-50'
                        }`}
                      style={{
